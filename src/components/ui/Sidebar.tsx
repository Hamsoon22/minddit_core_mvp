...
export default function Sidebar({
  ...
  return (
    <aside className="w-60 h-screen bg-white border-r border-gray-300 flex flex-col shrink-0">
      ...
      <div className="relative px-6 py-5 border-t border-gray-200" ref={menuRef}>
        {menuOpen && (
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-xl px-2 py-2 transition-colors hover:bg-gray-50"
        >
          <Image
